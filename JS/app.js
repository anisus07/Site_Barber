...
$(".liensNav:nth-child(1)").click(function() {
    $('html,body').animate({
            scrollTop: $("#acceuil").offset().top + 50 // moins 50 pour que la pointe de clip path ne rentre pas dans les titres 
        },
        'slow');
});
...
$(".liensNav:nth-child(3)").click(function() {
    $('html,body').animate({
            scrollTop: $("#tarifs").offset().top - 50 // moins 50 pour que la pointe de clip path ne rentre pas dans les titres 
        },
        'slow');
});
$(".liensNav:nth-child(4)").click(function() {
    $('html,body').animate({
            scrollTop: $("#contact").offset().top - 50 // moins 50 pour que la pointe de clip path ne rentre pas dans les titres 
        },
        'slow');
});